        ...
        where T : class, new()
    {
        ...
        public static I As<I>() where I : class
        {
            if (!typeof(I).IsInterface)
                throw new ArgumentException("Interface has to be Implemented !!!");
        ...
        public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result)
        {
            try
            {
                WriteLine($"Invoking {subject.GetType().Name}.{binder.Name} with " +
        ...
        public string Info
        {
            get
            {
                ...
                {
                    sb.AppendLine($"{kv.Key} was called {kv.Value} time(s)");
                }
